...
#
# Consolidated file aligned to YOUR class names.
...
def spawn_dataloader(txt, batch_size=4, max_length=256,
...
class AutoBlocks(nn.Module):
    def __init__(self, cfg):
        super().__init__()
        # FIX: use your class names (MultiHeadAttn, ConveyorBelt)
...
class Toilet(nn.Module):
    def __init__(self, cfg):
        ...
        # FIX: use AutoBlocks (your block class), not TransformerBlock
...
if __name__ == "__main__":
    ...
    # FIX: instantiate Toilet (your model), not GPTModel
