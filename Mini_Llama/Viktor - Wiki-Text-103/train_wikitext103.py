#!/usr/bin/env python3
"""
train_wikitext103.py — Train LLaMA on WikiText-103 with streaming
Features:
- Streaming WikiText-103 dataset (no full download required)
...
# Streaming Dataset
# =============================================================================
class StreamingWikiText103Dataset(IterableDataset):
    """
    Streaming dataset for WikiText-103.
    ...
    def __iter__(self) -> Iterator[Tuple[torch.Tensor, torch.Tensor]]:
        ...
        for sample in dataset:
            ...
            tokens = self.tokenizer.encode(text + "\n\n", allowed_special="all") if text else []
...
def create_dataloader(
    ...
    dataset = StreamingWikiText103Dataset(
        tokenizer=tokenizer,
...
def main():
    parser = argparse.ArgumentParser(description="Train LLaMA on WikiText-103")
    # Model args
